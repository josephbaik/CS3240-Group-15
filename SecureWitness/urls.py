...
urlpatterns = patterns('',
    ...
    url(r'^edit/(?P<report_id>[\w.@+-]+)/$', 'reportUpload.views.editreport', name='editreport'),
    ...
    url(r'^requesturls/?$', 'SecureWitness.views.requesturls', name = 'requesturls',),
    url(r'^requestkeys/?$', 'SecureWitness.views.requestkeys', name = 'requestkeys',),
